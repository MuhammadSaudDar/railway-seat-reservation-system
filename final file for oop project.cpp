...
class Detail
{
	public:
		...
		{
		    cout << "\n|Train No." << "\t" << "|Train Name" << "\t";
			cout<< "|Boarding pt." << "\t" << "|Destination pt."  <<"\t";
			cout << "|F-Class" << "\t"<< "|F-Class Fare" << "\t";
			cout<< "|S-Class" << "\t" << "|S-Class Fare" <<"\t";
			cout << "|Day" << "-" << "Month" << "-" << "Year" << "\n";
...
void database()
{
	...
	if(strcmp(pass,password)==0)
	{
		...
		do
		{
			...
			{
				case 1:
					f.open("detail_Database.txt",ios::out|ios::binary);
					do
					{
					a.getDetail();
					...
					break;
				case 2:
					f.open("detail_Database.txt",ios::in|ios::out|ios::binary|ios::app);
					a.getDetail();
					f.write((char *) & a,sizeof(a));
					f.close();
					break;
...
void res()
{
    ...
    fstream f1, f2;
    time_t t;
    f1.open("detail_Database.txt", ios::in | ios::out | ios::binary);
...
{
    fstream f;
    f.open("detail_Database.txt",ios::in|ios::out|ios::binary);
    Detail a;
    while(f.read((char *) & a,sizeof(a)))
    {
            a.displaydetail();
...
void user()
{
	...
	while(f.read((char *) & a,sizeof(a)))
	{
		if((strcmp(a.id,id)==0)&&(strcmp(a.pass,passcode)==0))
		{
			do
			{
	...
	if(d==1)
	{
		cout<<"Enter your user id and passcode correctly\n";
	}
}
